    ...
    public class ProductsDao
    {
        ...
        public bool EditProduct(Product product)
        {
            ...
            try
            {
                ...
                proDetail.xuatxu = product.ProductDetail.xuatxu;
                proDetail.tinhtrang = product.ProductDetail.tinhtrang;
                proDetail.dongxe = product.ProductDetail.dongxe;
                proDetail.sokmdadi = product.ProductDetail.sokmdadi;
                proDetail.mau = product.ProductDetail.mau;
